...
import pwnisher.mesh.wifi as wifi

from pwnisher.ai.reward import RewardFunction
...
class Epoch(object):
    ...
    def next(self):
        ...
        now = time.time()
        cpu = pwnisher.cpu_load("epoch")
        mem = pwnisher.mem_usage()
        temp = pwnisher.temperature()
